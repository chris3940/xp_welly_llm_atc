...
void update() {
    ...
    if (++frame_counter % 60 == 0) {
        ...
        XPLMNavRef airport_ref = XPLMFindNavAid(
            nullptr, nullptr, &lat, &lon, nullptr, xplm_Nav_Airport);

        if (airport_ref != XPLM_NAV_NOT_FOUND) {
            char icao[32] = {};
            XPLMGetNavAidInfo(airport_ref, nullptr, nullptr, nullptr,
                              nullptr, nullptr, nullptr, icao, nullptr, nullptr);
            ctx.nearest_airport_id = icao;

            XPLMNavRef ils_ref = XPLMFindNavAid(
                nullptr, icao, &lat, &lon, nullptr,
